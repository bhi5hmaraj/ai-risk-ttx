...
import { UserGroupIcon, ShareIcon, CheckCircleIcon, ClockIcon } from '../Icons';
...
export function WaitingRoom() {
  ...
  // Determine host (first player by join order)
        ...
        <div className="text-center">
          {isHost ? (
            <button
              ...
              className="w-full bg-green-600 hover:bg-green-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white font-bold py-4 px-6 rounded-lg transition-colors duration-200 text-lg"
            >
              Start Game
            </button>
          ) : (
