...
export const matrixTheme = {
  ...
  form: {
    ...
    input: 'w-full px-3 py-2 bg-gray-900/50 border border-emerald-400/30 rounded-lg text-gray-200 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400 hover:border-emerald-400/50 transition-all',
    textarea: 'w-full px-3 py-2 bg-gray-900/50 border border-emerald-400/30 rounded-lg text-gray-200 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400 hover:border-emerald-400/50 transition-all resize-none',
    select: 'w-full px-3 py-2 bg-gray-900/50 border border-emerald-400/30 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400 hover:border-emerald-400/50 transition-all',
    checkbox: 'w-4 h-4 text-emerald-500 bg-gray-900/50 border-emerald-400/30 rounded focus:ring-emerald-400/50 focus:ring-offset-gray-900',
    radio: 'w-4 h-4 text-emerald-500 bg-gray-900/50 border-emerald-400/30 focus:ring-emerald-400/50 focus:ring-offset-gray-900',
    ...
    buttonSecondary: 'px-4 py-2 bg-gray-800 hover:bg-gray-700 text-emerald-300 font-medium rounded-lg border border-emerald-400/30 hover:border-emerald-400/50 transition-all',
