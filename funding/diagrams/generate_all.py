...
print("=" * 60)
print("\nGenerated files:")
print("- player_journey.svg")
print("- progression_pathway.svg")
print("- success_timeline.svg")
print("- impact_dimensions.svg")
print("- impact_over_time.svg")
print("- partnership_value.svg")
print("- risk_mitigation.svg")
print("- mda_framework.svg")
print("- mda_development.svg")
