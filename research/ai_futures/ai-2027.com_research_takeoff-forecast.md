...
[Methodology](https://ai-2027.com/research/takeoff-forecast#methodology)

[From SC to SAR](https://ai-2027.com/research/takeoff-forecast#from-sc-to-sar)

[From SAR to SIAR](https://ai-2027.com/research/takeoff-forecast#from-sar-to-siar)

[From SIAR to ASI](https://ai-2027.com/research/takeoff-forecast#from-siar-to-asi)

[Related work](https://ai-2027.com/research/takeoff-forecast#related-work)

[Addressing common objections](https://ai-2027.com/research/takeoff-forecast#addressing-common-objections)

[Limitations](https://ai-2027.com/research/takeoff-forecast#limitations)

[Appendix](https://ai-2027.com/research/takeoff-forecast#appendix)
...
Our [methodology](https://ai-2027.com/research/takeoff-forecast#methodology) focuses on predicting the viability and speed of a [software-driven intelligence explosion](https://www.forethought.org/research/will-ai-r-and-d-automation-cause-a-software-intelligence-explosion), in which there is vast improvement in AI capabilities on the scale of months-years primarily driven by using compute more efficiently (improved software), rather than more training or inference compute. First, we enumerate a progression of [AI capability milestones](https://ai-2027.com/research/takeoff-forecast#milestone-definitions), with a focus on AI R&D capabilities, though we think general capabilities will also be improving. Then, for each gap between milestones A and B, we:

1. [**Human-only time required**](https://ai-2027.com/research/takeoff-forecast#human-only-software-only-forecast) **:** Forecast a distribution for how long it would take to get from A to B with only humans working on software improvements.

2. [**AI R&D speedup**](https://ai-2027.com/research/takeoff-forecast#accounting-for-ai-randd-automation-the-ai-randd-progress-multiplier) **:** Forecast how much AI R&D automation due to each of milestones A and B will speed up progress, then run a simulation in which the speedup is interpolated between these speedups over time to get a forecasted distribution for the calendar time between A and B (the [AI R&D progress multiplier](https://ai-2027.com/research/takeoff-forecast#ai-randd-progress-multiplier-definition)).


Takeoff MethodologySuperhumancoderSuperhuman AIResearcherCapability LevelStep 1: Estimate X, thehuman-only time to SARForecastXStep 2: Estimate the AI R&D progress multiplierStep 3: Repeat for thenext capability milestoneHuman-only progressForecasted real progress
...
| --- | --- | --- | --- | --- |
| **Superhuman coder (SC)**: An AI system that can do the job of the best human coder on tasks involved in AI research but faster, and cheaply enough to run lots of copies. | Mar 2027 | Mar 2027 | SC to SAR: 15% 0 years; Otherwise 4 years (80% CI: 1.5 to 10; lognormal) ( [reasoning](https://ai-2027.com/research/takeoff-forecast#human-only-timeline-from-sc-to-sar)) | 5 ( [reasoning](https://ai-2027.com/research/takeoff-forecast#sc-would-5x-ai-randd)) |
| **Superhuman AI researcher (SAR)**: An AI system that can do the job of the best human AI researcher but faster, and cheaply enough to run lots of copies. | Jul 2027 (Mar 2027 to Mar 2028) | Aug 2027 | SAR to SIAR: 19 years (80% CI: 2.3 to 380) ( [reasoning](https://ai-2027.com/research/takeoff-forecast#human-only-timeline-from-sar-to-siar)) | 25 ( [reasoning](https://ai-2027.com/research/takeoff-forecast#sar-would-25x-ai-randd)) |
| **Superintelligent AI researcher (SIAR):** An AI system that is vastly better than the best human researcher at AI research. | Nov 2027 (May 2027 to 2034) | Nov 2027 | SIAR to ASI: 95 years (80% CI: 2.4 to 1,000,000) ( [reasoning](https://ai-2027.com/research/takeoff-forecast#from-siar-to-asi)) | 250 ( [reasoning](https://ai-2027.com/research/takeoff-forecast#siar-would-250x-ai-randd)) |
| **Artificial superintelligence (ASI):** An AI system that is much better than the best human at every cognitive task. | Apr 2028 (Jun 2027 to >2100) | Dec 2027 | N/A | 2,000 ( [reasoning](https://ai-2027.com/research/takeoff-forecast#asi-would-2000x-ai-randd)) |

Below, we:

1. Describe [our methodology](https://ai-2027.com/research/takeoff-forecast#methodology) for forecasting takeoff.

2. More rigorously define the above milestones and the [AI R&D progress multiplier](https://ai-2027.com/research/takeoff-forecast#ai-randd-progress-multiplier-definition).
...
4. [Address potential objections](https://ai-2027.com/research/takeoff-forecast#addressing-common-objections).
...
First, we enumerate a progression of AI capability milestones (more precise definitions [below](https://ai-2027.com/research/takeoff-forecast#milestone-definitions)):
...
2. [**AI R&D speedup**](https://ai-2027.com/research/takeoff-forecast#accounting-for-ai-randd-automation-the-ai-randd-progress-multiplier) **:** Forecast how much AI R&D automation due to each of milestones A and B will speed up progress, then run a simulation in which the multiplier is interpolated between these over time to get a forecasted distribution for the calendar time between A and B (the [AI R&D progress multiplier](https://ai-2027.com/research/takeoff-forecast#ai-randd-progress-multiplier-definition)).
...
For clarifications on details of the progress multiplier definition, see the [appendix](https://ai-2027.com/research/takeoff-forecast#ai-randd-progress-multiplier-clarifications).
...
Our approach will be (as described [above](https://ai-2027.com/research/takeoff-forecast#methodology)):

1. Forecast how long it would take to get from SC to SAR if only humans were doing the AI R&D with a fixed hardware supply ( [here](https://ai-2027.com/research/takeoff-forecast#human-only-timeline-from-sc-to-sar)).

2. Forecast how much having an SC and SAR would speed this up ( [here](https://ai-2027.com/research/takeoff-forecast#sc-would-5x-ai-randd) and [here](https://ai-2027.com/research/takeoff-forecast#sar-would-25x-ai-randd)).
...
|  | Forecast | Reasoning |
| --- | --- | --- |
| SC to SAR, humans-only software-only time | 15% 0 years; Otherwise 4 years (80% CI: 1.5 to 10; lognormal) | Case-based analysis depending on the requirements for training an SAR ( [more](https://ai-2027.com/research/takeoff-forecast#human-only-timeline-from-sc-to-sar)). |
| SC progress multipler | 5 | Decomposition of various speedups that an SC provides ( [more](https://ai-2027.com/research/takeoff-forecast#sc-would-5x-ai-randd)). |
| SAR progress multiplier (in [next section](https://ai-2027.com/research/takeoff-forecast#sar-would-25x-ai-randd), needed to calculate intermediate speedups) | 25 | A combination of 3 methods, most prominently relying on surveys of AI researchers answering questions about various hypothetical scenarios ( [more](https://ai-2027.com/research/takeoff-forecast#sar-would-25x-ai-randd)). |
| Time between SC and SAR | 0.3 years (15% 0 years, 90th percentile 0.95 years) [_FutureSearch aggregate_](http://futuresearch.ai/ai-2027) _(n=4): 0.55 years (0, 2.1)_ | Results of [simulation](https://github.com/uvafan/timelines-takeoff-ai-2027) |
...
| --- | --- | --- |
| [1)](https://ai-2027.com/research/takeoff-forecast#case-1-the-first-sc-is-already-an-sar-15percent) The first SC is already an SAR or very close to one (15%) | 0 years | Moravec’s paradox and general inability to guess which skills will turn out to be harder than others ( [more](https://ai-2027.com/research/takeoff-forecast#case-1-the-first-sc-is-already-an-sar-15percent)). |
| [2a)](https://ai-2027.com/research/takeoff-forecast#sub-case-a-training-the-missing-sar-skills-isnt-more-compute-intensive-than-the-sc-25percent) Training the missing SAR skills isn’t more compute intensive than the SC (25%) | 2 years (80% CI 1 to 4; lognormal) | Perhaps new training environments are needed but they aren’t more compute-intensive than the ones needed for SC because the skills aren’t that different ( [more](https://ai-2027.com/research/takeoff-forecast#sub-case-a-training-the-missing-sar-skills-isn%E2%80%99t-more-compute-intensive-than-the-sc-25%))). |
| [2b)](https://ai-2027.com/research/takeoff-forecast#sub-case-b-training-the-missing-sar-skills-would-be-more-compute-intensive-than-the-sc-absent-further-algorithmic-progress-30percent) Training the missing SAR skills would be more compute-intensive than the SC absent further algorithmic progress (30%) | ~5 years (80% CI: 2 to 15; lognormal) | Perhaps new training environments are needed and they are substantially more compute-intensive as well, e.g. larger teams of agents doing big ML research projects over subjective years rather than medium-sized ML coding projects over subjective months ( [more](https://ai-2027.com/research/takeoff-forecast#sub-case-b-training-the-missing-sar-skills-would-be-more-compute-intensive-than-the-sc-absent-further-algorithmic-progress-30percent)). |
| [3)](https://ai-2027.com/research/takeoff-forecast#case-3-30percent-crossing-the-gap-from-sc-to-sar-is-a-scientific-rather-than-an-engineering-problem) Crossing the gap from SC to SAR is a scientific rather than an engineering problem (30%) | ~5 years (80% CI: 2 to 15; lognormal) | We’d guess that this is the sort of limitation that would take years to overcome — but not decades; just look at the past decade of progress e.g. from AlphaGo to EfficientZero ( [more](https://ai-2027.com/research/takeoff-forecast#case-3-30percent-crossing-the-gap-from-sc-to-sar-is-a-scientific-rather-than-an-engineering-problem)). |
...
|  | Forecast | Reasoning |
| --- | --- | --- |
| SAR to SIAR, humans-only software-only time | 19 years (80% CI: 2.3 to 380) [_FutureSearch aggregate_](http://futuresearch.ai/ai-2027) _conditional on SAR in 2027 (n=3): 11.5 years (1.75, 27)_ | Based on comparing the time between automated median researcher and SAR ( [more](https://ai-2027.com/research/takeoff-forecast#human-only-timeline-from-sar-to-siar)). |
| SAR progress multiplier | 25x | A combination of 3 methods, most prominently relying on surveys of AI researchers answering questions about various hypothetical scenarios ( [more](https://ai-2027.com/research/takeoff-forecast#sar-would-25x-ai-randd)). |
| SIAR progress multiplier (in [next section](https://ai-2027.com/research/takeoff-forecast#siar-would-250x-ai-randd), needed to calculate intermediate speedups) | 250x | Based on survey data regarding returns to better researchers within the human range ( [more](https://ai-2027.com/research/takeoff-forecast#siar-would-250x-ai-randd)). |
| Time between SAR and SIAR | 0.3 years (80% CI: 0.04 to 56 [_FutureSearch aggregate_](http://futuresearch.ai/ai-2027) _conditional on SAR in 2027 (n=3): 1 year (0.1, 2.1)_ | Via [simulation](https://github.com/uvafan/timelines-takeoff-ai-2027) |
...
1. Case 1: 5
      ...
      1. This is about 0.6 doublings leading to about a 5x progress multiplier, according to the above survey. So this would be r = ~4 (each doubling in total effort means 4 doublings in progress multiplier), which is on the high end of [Davidson’s calculations](https://docs.google.com/document/d/1rw1pTbLi2brrEP0DcsZMAVhlKp6TKGKNUSFRkkdP_hs/edit?tab=t.0#heading=h.zdfvbdepj7yk) but not wildly off. We tend to have higher r estimations than Davidson due to putting more weight on the importance of qualitative capability jumps (more [below](https://ai-2027.com/research/takeoff-forecast#davidsons-what-a-compute-centric-framework-says-about-takeoff-speeds)).
2. Case 2: 10
...
First, we discuss [what having SARs will look like](https://ai-2027.com/research/takeoff-forecast#what-having-sars-will-look-like). Then, we forecast the SAR progress multiplier via a few methods:

|  | Forecasted progress multiplier | Reasoning |
| --- | --- | --- |
| Method 1: [Speedup decomposition](https://ai-2027.com/research/takeoff-forecast#method-1-speedup-decomposition) | 417 (90% CI: 130 to 1900) | Combining a breakdown of expected speedups from SAR |
| Method 2: [Surveys on subquestions](https://ai-2027.com/research/takeoff-forecast#method-2-surveys-on-subquestions) | 26 (90% CI: 8 to 139) | A progression of hypothetical scenarios informed by our surveys of AI researchers |
| Method 3: [More direct survey](https://ai-2027.com/research/takeoff-forecast#method-3-more-direct-survey) | 24 (90% CI: 5 to 112) | We take a [recent survey](https://www.forethought.org/research/could-advanced-ai-accelerate-the-pace-of-ai-progress-interviews-with-ai) of researchers about how much progress would speed up if every company employee had access to 30x copies thinking at 30x speed, then adjust upward for all SARs being as good as the best researchers. |
...
|  | Forecast | Reasoning |
| --- | --- | --- |
| [SIAR to ASI, humans-only software-only time](https://ai-2027.com/research/takeoff-forecast#human-only-timeline-from-siar-to-asi) | 95 years (80% CI: 2.4 to 1,000,000) | Based on comparing the jump to that from a SAR to SIAR ( [more](https://ai-2027.com/research/takeoff-forecast#human-only-timeline-from-siar-to-asi)). |
| [SIAR progress multiplier](https://ai-2027.com/research/takeoff-forecast#siar-would-250x-ai-randd) | 250x | Based on survey data regarding returns to better researchers within the human range ( [more](https://ai-2027.com/research/takeoff-forecast#siar-would-250x-ai-randd)). |
| [ASI progress multiplier](https://ai-2027.com/research/takeoff-forecast#asi-would-2000x-ai-randd) (needed to calculate intermediate speedups) | 2,000x | Based on comparing the jump to that from a SAR to SIAR ( [here](https://ai-2027.com/research/takeoff-forecast#asi-would-2000x-ai-randd)). |
...
I’ll think about this in relative terms to how long it takes to cross from SAR to SIAR human-only as forecasted [above](https://ai-2027.com/research/takeoff-forecast#heading=h.wwky4apb3rya).
...
Again using a Davidson-style function for diminishing returns as I did for [SAR to SIAR](https://ai-2027.com/research/takeoff-forecast#human-only-timeline-from-sar-to-siar), I then model time required to get from SIAR to ASI by doing the following:
...
2. Use the same formula structure as used for [SAR to SIAR](https://ai-2027.com/research/takeoff-forecast#human-only-timeline-from-sar-to-siar) to compute the forecasted distribution.
...
Some of the model parameters were chosen by Daniel and others by Eli. Due to time constraints, we weren’t able to independently make estimates for each parameter. To the extent this forecast represents a single person’s view, it’s closer to being Daniel than Eli. That being said, they both find the overall distributions plausible.

3.

We also solicited forecasts from 4 professional forecasters from [FutureSearch](https://futuresearch.ai/) (bios at [http://futuresearch.ai/ai-2027](http://futuresearch.ai/ai-2027)). Their forecasts for SC->SAR and SAR->SIAR are included as footnotes in the table below, and expanded upon in later sections.

4.

These are sometimes different from the projected dates because we have been making adjustments to our timelines and takeoff forecasts beyond when we locked in the progression in the scenario. As you can see, we have enough uncertainty that we find the dates in the scenario nearly as plausible as our medians.

5.

FutureSearch aggregate: Oct 2027 (Mar 2027 to Apr 2029)

6.

[FutureSearch aggregate](https://ai-2027.com/research/takeoff-forecast#heading=h.olwhwylhlp4e), years from SAR->SIAR conditional on SAR in 2027: 1 year (0.1, 2.1) ( [more](https://ai-2027.com/research/takeoff-forecast#heading=h.q591y7b45azm))
...
The reason 5% is used is because it’s approximately the fraction that we project AI projects to be spending around the time they reach SC: see the “Research automation” row in our [compute supplement](https://ai-2027.com/supplements/compute-forecast#section-3-compute-usage).

9.

Note that an “agent” may on average use multiple model copies/instances running at once, e.g. in the simplest case doing [best of many tries in parallel](https://arxiv.org/pdf/2412.03556).

10.

Technically, we define this and the below milestones are based on 30x the amount of human researchers they would have based on our best projections as of 2025 ignoring research automation, to account for issues around hiring more slowly or firing people due to them being automated substantially changing the milestone. (see [clarification (2) below](https://ai-2027.com/research/takeoff-forecast#ai-randd-progress-multiplier-definition)).

11.

We aren’t including experiment bottlenecks or other non-cognitive bottlenecks. when measuring task completion speed.

12.

This definition is similar to that of [this report](https://www.forethought.org/research/could-advanced-ai-accelerate-the-pace-of-ai-progress-interviews-with-ai) which interviewed AI researchers about AI R&D automation. In our case, we say that all agents are 30x faster than the best researcher, while they discuss one copy of each researcher sped up 30x.

13.

It doesn’t make sense for the definition to use labor rather than log(labor), because this would fit the distribution of AI researcher abilities worse.

14.

We focus on AI R&D capabilities because it is the most relevant for takeoff forecasting, but we believe general capabilities and capabilities in other domains will also be improving rapidly, with varying levels of lag compared to AI R&D-specific capabilities.

15.

This takes into account compute bottlenecks, but not diminishing returns over time due to picking low-hanging fruit (which we prefer not to include in order to isolate the algorithmic progress variable in our takeoff forecasting, as well as the most obvious versions of adjusting being highly sensitive to choices like whether to take the log() of the chosen metric).
...
They might not be faster and cheaper at literally every task, but they will likely have massive advantages in many mportant respects.

21.

We could also talk about labor directly, and our best guess would be that the picture stays roughly the same.

22.

If there were no humans to help improve taste their labor is probably still more valuable as the median OpenBrain researcher but less valuable than the 90th percentile, as their engineering skills make up for their taste deficit.
...
See [this spreadsheet](https://docs.google.com/spreadsheets/d/1dcNHLU6PlkqxnCmiVs6S_gO9lE7qncc1uNN88mcIBaA/edit?gid=0#gid=0) for calculations.

34.

((STOCK\_THROUGH\_SAR+SAR\_TO\_SIAR\_YEARS)\*2^(SAR\_TO\_SIAR\_EQUIV\_JUMPS\*log(((STOCK\_THROUGH\_SAR+SAR\_TO\_SIAR\_YEARS)/STOCK\_THROUGH\_SAR)/log(2))-((STOCK\_THROUGH\_SAR+SAR\_TO\_SIAR\_YEARS)

35.

Eth and Davidson recently published follow-up work on the likelihood of a software intelligence explosion [here](https://www.forethought.org/research/will-ai-r-and-d-automation-cause-a-software-intelligence-explosion). While presented in a more polished, way it doesn’t depart much from [the core points of the relevant section in the 2023 report](https://docs.google.com/document/d/1rw1pTbLi2brrEP0DcsZMAVhlKp6TKGKNUSFRkkdP_hs/edit?tab=t.0#heading=h.iaqy7rxuutko).

36.

Epoch estimates r in a similar manner in [this paper](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4814445).
