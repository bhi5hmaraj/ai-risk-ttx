...
const TimelineItemZ = z.object({
  ...
  impact: z.string(),
  causes: z.array(CauseZ).nullable(),
}).strict();
...
const DebriefEventZ = z.object({ round: z.number().int().min(1), title: z.string(), description: z.string(), impact: z.string(), actor: z.string().nullable(), causes: z.array(CauseZ).nullable() }).strict();
