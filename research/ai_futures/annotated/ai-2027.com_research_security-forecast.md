...
[Summary](https://ai-2027.com/research/security-forecast#summary)

[Section 1. Security levels](https://ai-2027.com/research/security-forecast#section-1-security-levels)

[Section 2. Cyberwarfare and sabotage](https://ai-2027.com/research/security-forecast#section-2-cyberwarfare-and-sabotage)

[Section 3. Loss of control: Subversion and self-exfiltration](https://ai-2027.com/research/security-forecast#section-3-loss-of-control-subversion-and-self-exfiltration)

[Appendix](https://ai-2027.com/research/security-forecast#appendix)

# Security Forecast

### _Romeo Dean \| April 2025_

![Weights security timeline](https://ai-2027.com/weights-security-timeline.png)![Secrets security timeline](https://ai-2027.com/secrets-security-timeline.png)

Figure 1: Overview of the forecasted Security level timeline in AI 2027. We extend [RAND’s definition](https://ai-2027.com/research/security-forecast#RAND-s-security-levels) of security levels to distinguish between [model weights](https://ai-2027.com/research/security-forecast#model-weights-exfiltration) and [algorithmic secrets](https://ai-2027.com/research/security-forecast#algorithmic-secrets) security. OpenBrain and DeepCent are pseudonyms we use for the leading US and China AI companies.

## Introduction

Many important events and dynamics in AI 2027 have required informed forecasting on matters related to information security and cybersecurity. This supplement explains and justifies our expectations on the **security levels of leading US and Chinese AI projects** ( [Section 1](https://ai-2027.com/research/security-forecast#section-1-security-levels)), **AI’s capabilities in hacking and cyberwarfare** ( [Section 2](https://ai-2027.com/research/security-forecast#section-2-cyberwarfare-and-sabotage)), and AI’s likelihood of **success in attempts to obtain root control of its own servers** ( [Section 3](https://ai-2027.com/research/security-forecast#section-3-loss-of-control-subversion-and-self-exfiltration)). Several forecasts have been partially informed by anonymous polling of security professionals at AI security workshops. Naturally many predictions have high uncertainty and we welcome reasoned disagreements with our numbers and estimates in order to improve our forecast. **All projections in this document are justified through December 2027 following the ‘racing’ branch of the scenario.**
...
Figure 2: Overview of our forecasted timeline for Model [Weights Security Levels](https://ai-2027.com/research/security-forecast#model-weights-exfiltration) and [Algorithmic Secrets Security](https://ai-2027.com/research/security-forecast#algorithmic-secrets) levels. OpenBrain and DeepCent are pseudonyms we use for the leading US and China AI companies.

#### [Section 2. Cyberwarfare and sabotage](https://ai-2027.com/research/security-forecast\#section-2-cyberwarfare-and-sabotage)

[Cybench](https://cybench.github.io/) is a collection of 40 Capture the Flag (CTF) problems from 4 professional-level CTF competitions spanning a wide range of difficulties. Our forecasts below allow for an AI to have up to 10 submission attempts (PASS@10 with feedback) but the AI must complete the tasks at human-cost parity.
...
![](https://ai-2027.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FFIGURE_6.4d84d899.png&w=3840&q=75)ai-2027.comFigure 4: Our estimated and projected partial subversion, full subversion and self-exfiltration success probabilities for OpenBrain and DeepCent’s best internal AI models through 2027. Note that by December 2027 OpenBrain’s best model (Agent-5) is capable of speeding up AI R&D 1000x.
...
![Weights security timeline](https://ai-2027.com/weights-security-timeline.png)

Figure 5: Overview of our forecasted timeline for Model Weights Security Levels.![](https://ai-2027.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FFIGURE_7.0cb13c1b.png&w=3840&q=75)ai-2027.comFigure 6: This question on whether a state actor would steal a frontier US AI model before 2030 showed strong consensus – a sign that current security levels are far from protecting against a state-actor threat.
...
![Secrets security timeline](https://ai-2027.com/secrets-security-timeline.png)
...
![](https://ai-2027.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FFIGURE_1.b4473884.png&w=3840&q=75)ai-2027.comFigure 11: Overview of our forecasted privileged access employees and compromised employees by company.
...
![](https://ai-2027.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FFIGURE_2.23e5dfb4.png&w=3840&q=75)ai-2027.comFigure 12: Overview of our forecasted Cybench and Hacking Horizon progression by company.

![](https://ai-2027.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FFIGURE_3.43cc5993.png&w=3840&q=75)ai-2027.comFigure 13: Overview of our forecasted 1-day and 1-month Top Hacker Equivalents progression by company.
...
![](https://ai-2027.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcybench-nowatermark.397d1fd8.png&w=3840&q=75)Figure 14: Cybench difficulty distribution.
...
Nevo, Sella, Dan Lahav, Ajay Karpur, Yogev Bar-On, Henry Alexander Bradley, and Jeff Alstott, Securing AI Model Weights: Preventing Theft and Misuse of Frontier Models. Santa Monica, CA: RAND Corporation, 2024. [https://www.rand.org/pubs/research\_reports/RRA2849-1.html](https://www.rand.org/pubs/research_reports/RRA2849-1.html). Also available in print form.
...
Zhang, Andy K., Neil Perry, Riya Dulepet, Joey Ji, Justin W. Lin, Eliot Jones, Celeste Menders et al. "Cybench: A framework for evaluating cybersecurity capabilities and risks of language models." _arXiv preprint arXiv:2408.08926_ (2024).
