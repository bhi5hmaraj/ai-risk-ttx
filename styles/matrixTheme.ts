...
export const matrixTheme = {
  ...
  form: {
    ...
    input: 'w-full px-3 py-2 bg-gray-900/80 border border-emerald-400/50 rounded-lg text-emerald-100 placeholder-emerald-900/40 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400 hover:border-emerald-400/70 transition-all',
    textarea: 'w-full px-3 py-2 bg-gray-900/80 border border-emerald-400/50 rounded-lg text-emerald-100 placeholder-emerald-900/40 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400 hover:border-emerald-400/70 transition-all resize-none',
    select: 'w-full px-3 py-2 bg-gray-900/80 border border-emerald-400/50 rounded-lg text-emerald-100 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400 hover:border-emerald-400/70 transition-all',
