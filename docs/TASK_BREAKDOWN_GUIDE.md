...
|------|-------------|--------|
| 1.1 | Next.js custom server setup | Sets up architecture |
...
|------|-------------|----------|
| 4.1 | Admin API routes | HIGH - needed for troubleshooting |
| 4.2 | Admin dashboard UI | HIGH - on-site debugging |
...
|------|-------------|-----------------|
| 5.1 | Dockerfile for custom server | Containerize Next.js + Colyseus |
